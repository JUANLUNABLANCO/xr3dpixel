...
// ################################### SSL CERTIFICATE
const credentials = {
    ca: fs.readFileSync(__dirname + "/app_server/_configs/ssl/xr3dpixel_com.ca-bundle", 'utf8'), //la certification authority o CA
    key: fs.readFileSync(__dirname + "/app_server/_configs/ssl/xr3dpixel_com.key", 'utf8'), //la clave SSL, que es el primer archivo que generamos ;)
    cert: fs.readFileSync(__dirname + "/app_server/_configs/ssl/xr3dpixel_com.crt", 'utf8') //el certificado
};
// ################################### SSL CERTIFICATE
//
...
if (app.get('env') == 'production') {
    var Server = https.createServer(credentials, app)
        .listen(app.get('PORT'), function() {
            ...
            console.log('Express server with SSL certificate listening in https://www.xr3dpixel.com:' + Server.address().port);
        });
}
// servidor local http://localhost:3000
    ...
    var Server = app.listen(app.get('PORT'), function() {
        console.log("NODE_ENV: ", app.get('ENV'));
        console.log("PORT: ", app.get('PORT'));
        console.log("MONGO_URL: ", app.get('MONGO_URL') || 'no establecido por docker!');
