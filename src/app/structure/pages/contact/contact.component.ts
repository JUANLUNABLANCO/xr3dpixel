...
export class ContactComponent implements OnInit {
  ...
  constructor(public _contactService: ContactService, private activatedRoute: ActivatedRoute) {
    this.contactMessage = {
      name: '',
  ...
  ngOnInit() {
    ...
    if (this.reason){
      ...
      this.activatedRoute.params.subscribe((params: Params)=>{
        ...
        if (this.reason == "app"){
          this.contactMessage.message = "He visto vuestro ejemplo de Realidad Aumentada y puedo estar interesado, en alguno de vuestros productos o servicios. Me gustaria saber mas y concertar una cita o ponerme en contacto con vosotros.";
        }else if (this.reason == "asesoria") {
          this.contactMessage.message = "Me gusta vuestras maneras y filosofía de trabajo y quiero que, hagais un estudio valorativo de mi empresa. Me gustaria saber mas y concertar una cita o ponerme en contacto con vosotros.";
        } else {
